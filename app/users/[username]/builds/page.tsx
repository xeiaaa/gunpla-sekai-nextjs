...
export default async function UserBuilds({ params, searchParams }: UserBuildsPageProps) {
  ...
  const builds = await getUserBuilds(user.id, 20, status === "all" ? undefined : status, sort);

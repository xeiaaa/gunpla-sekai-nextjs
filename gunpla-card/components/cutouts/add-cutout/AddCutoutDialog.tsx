...
const CirclePolygonCropper = dynamic(() => import("./CirclePolygonCropper"), {
  ssr: false,
});
const RectangleCropper = dynamic(() => import("./RectangleCropper"), {
  ssr: false,
});
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {mode === "rectangle"
                  ...
                  : mode === "circle"
                  ? "Drag to move. Scroll to resize radius."
                  : mode === "polygon"
                  ? polygonClosed
                    ? "Polygon closed."
                    : "Click to add points. Close when done."
                  : ""}
              </p>
            </div>
        ...
        {mode === "rectangle" ? (
          ...
          <CirclePolygonCropper
            ref={cpRef as any}
            sourceUrl={sourceUrl}
            mode={mode === "circle" ? "circle" : "polygon"}
